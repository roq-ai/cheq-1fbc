          ...
          <TableContainer>
            <Table variant="simple">
              <Thead>
                <Tr>
                  <Th>name</Th>
                  {hasAccess('network', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && <Th>network</Th>}
              ...
              <Tbody>
                {data?.map((record) => (
                  <Tr cursor="pointer" onClick={() => handleView(record.id)} key={record.id}>
                    <Td>{record.name}</Td>
                    {hasAccess('network', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                      <Td>
                        <Link as={NextLink} href={`/networks/view/${record.network?.id}`}>
                          {record.network?.name}
                        </Link>
                      </Td>
                    )}
